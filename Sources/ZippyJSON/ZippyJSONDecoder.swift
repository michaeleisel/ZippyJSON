...
//    let context:
    ...
    fileprivate func unbox<T>(_ value: Value, as type: DictionaryWithoutKeyConversion.Type) throws -> T {
        ...
        if let innerKeyError = innerKeyError {
            throw innerKeyError
        }
...
extension __JSONDecoder {
    ...
    private func throwingJNTErorr<T>(value: Value, _ execute: () -> T) throws -> T {
        ...
        if JNTErrorDidOccur(context) {
            let error = swiftErrorFromError(context)
            JNTClearError(context)
            throw error
        }
    ...
    fileprivate func unbox(_ value: Value, as type: UInt8.Type) throws -> UInt8 {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__uint8_t(value) }
    }

    fileprivate func unbox(_ value: Value, as type: UInt16.Type) throws -> UInt16 {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__uint16_t(value) }
    }

    fileprivate func unbox(_ value: Value, as type: UInt32.Type) throws -> UInt32 {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__uint32_t(value) }
    }

    fileprivate func unbox(_ value: Value, as type: UInt64.Type) throws -> UInt64 {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__uint64_t(value) }
    }

    fileprivate func unbox(_ value: Value, as type: Int8.Type) throws -> Int8 {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__int8_t(value) }
    }

    fileprivate func unbox(_ value: Value, as type: Int16.Type) throws -> Int16 {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__int16_t(value) }
    }

    fileprivate func unbox(_ value: Value, as type: Int32.Type) throws -> Int32 {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__int32_t(value) }
    }

    fileprivate func unbox(_ value: Value, as type: Int64.Type) throws -> Int64 {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__int64_t(value) }
    }

    fileprivate func unbox(_ value: Value, as type: Bool.Type) throws -> Bool {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__Bool(value) }
    }

    fileprivate func unbox(_ value: Value, as type: String.Type) throws -> String {
        return try self.throwingJNTErorr(value: value) {
    ...
    fileprivate func unbox(_ value: Value, as type: Double.Type) throws -> Double {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__Double(value) }
    }

    fileprivate func unbox(_ value: Value, as type: Float.Type) throws -> Float {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__Float(value) }
    }

    fileprivate func unbox(_ value: Value, as type: Int.Type) throws -> Int {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__Int(value) }
    }

    fileprivate func unbox(_ value: Value, as type: UInt.Type) throws -> UInt {
        return try self.throwingJNTErorr(value: value) { return JNTDocumentDecode__UInt(value) }
    }
